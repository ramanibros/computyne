...
const TestimonialsMod2 = () => {
	const testimonials = getTestimonials()?.slice(0, 6);

	return (
		<section className="tj-testimonial-section section-gap gap-bottom section-gap-x">
							...
							>
								{testimonials?.length
									? testimonials?.map((testimonial, idx) => (
											<SwiperSlide key={idx}>
												<IndustriesCard blog={testimonial} idx={idx} />
											</SwiperSlide>
									  ))
									: ""}
...
export default TestimonialsMod2;
